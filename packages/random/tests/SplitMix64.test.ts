...
import SplitMix64 from '../dist/SplitMix64.js';

describe('SplitMix64', () => {
    it('should generate deterministic sequences with same seed', () => {
        const rng1 = new SplitMix64(12345);
        const rng2 = new SplitMix64(12345);
    ...
    it('should generate different sequences with different seeds', () => {
        const rng1 = new SplitMix64(12345);
        const rng2 = new SplitMix64(54321);
    ...
    it('should allow getting seed/state', () => {
        ...
        const rng = new SplitMix64(initialSeed);
